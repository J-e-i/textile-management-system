...
const BuyerLayout = () => {
  ...
  const navItems = [
    { name: "Dashboard", path: "/buyer", icon: LayoutDashboard, end: true },
    { name: "New Order", path: "/buyer/new-order", icon: PlusCircle },
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-30 h-16 border-b border-border bg-background flex items-center px-4 lg:px-6">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-semibold text-foreground">Buyer Dashboard</h1>
          </div>
